...
export default class LeafletMap extends Component {
  ...
  componentDidMount() {
    ...
    L.tileLayer(
      `https://tile.openweathermap.org/map/temp_new/{z}/{x}/{y}.png?appid=a09d1c56233d10c3e4db1dd590968ea6`,
      {
        detectRetina: true,
        maxZoom: 20,
        attribution:
          '&copy; <a href="https://www.openweathermap.org/copyright">OpenWatherMap</a> contributors',
        maxNativeZoom: 17
      }
    ).addTo(this.map);
  }
  ...
  render() {
    return (
      <>
        <div
          id="map"
          style={{ width: "70vw", height: "70vh", marginLeft: "8%" }}
          className={classes.OpenWeatherMap}
        ></div>
